...
/* Extended ASCII to Unicode character lookup table for the MacCyrillic codepage
 * Unknown are filled with the Unicode replacement character 0xfffd
 */
const uint16_t libuna_codepage_mac_cyrillic_byte_stream_to_unicode_base_0x80[ 128 ] = {
...
/* Unicode to ASCII character lookup tables for the MacCyrillic codepage
 * Unknown are filled with the ASCII replacement character 0x1a
 */
const uint8_t libuna_codepage_mac_cyrillic_unicode_to_byte_stream_base_0x00a0[ 32 ] = {
...
const uint8_t libuna_codepage_mac_cyrillic_unicode_to_byte_stream_base_0x0400[ 96 ] = {
...
const uint8_t libuna_codepage_mac_cyrillic_unicode_to_byte_stream_base_0x2010[ 24 ] = {
	0x1a, 0x1a, 0x1a, 0xd0, 0xd1, 0x1a, 0x1a, 0x1a,
	0xd4, 0xd5, 0x1a, 0x1a, 0xd2, 0xd3, 0xd7, 0x1a,
	0xa0, 0x1a, 0xa5, 0x1a, 0x1a, 0x1a, 0xc9, 0x1a
};

/* Copies an Unicode character from a MacCyrillic encoded byte stream
...
{
	static char *function                             = "libuna_codepage_mac_cyrillic_copy_from_byte_stream";
	...
	else
	{
		...
		safe_unicode_character = libuna_codepage_mac_cyrillic_byte_stream_to_unicode_base_0x80[ byte_stream_character ];
	}
...
/* Copies an Unicode character to a MacCyrillic encoded byte stream
 * Returns 1 if successful or -1 on error
 */
int libuna_codepage_mac_cyrillic_copy_to_byte_stream(
     ...
     libcerror_error_t **error )
{
	static char *function         = "libuna_codepage_mac_cyrillic_copy_to_byte_stream";
	size_t safe_byte_stream_index = 0;
	      ...
	      && ( unicode_character < 0x00c0 ) )
	{
		...
		byte_stream_value = libuna_codepage_mac_cyrillic_unicode_to_byte_stream_base_0x00a0[ unicode_character ];
	}
	      ...
	      && ( unicode_character < 0x0460 ) )
	{
		...
		byte_stream_value = libuna_codepage_mac_cyrillic_unicode_to_byte_stream_base_0x0400[ unicode_character ];
	}
	      ...
	      && ( unicode_character < 0x2028 ) )
	{
		...
		byte_stream_value = libuna_codepage_mac_cyrillic_unicode_to_byte_stream_base_0x2010[ unicode_character ];
	}
