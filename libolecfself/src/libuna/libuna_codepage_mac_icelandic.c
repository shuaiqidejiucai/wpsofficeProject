...
/* Extended ASCII to Unicode character lookup table for the MacIcelandic codepage
 * Unknown are filled with the Unicode replacement character 0xfffd
 */
const uint16_t libuna_codepage_mac_icelandic_byte_stream_to_unicode_base_0x80[ 128 ] = {
...
/* Unicode to ASCII character lookup tables for the MacIcelandic codepage
 * Unknown are filled with the ASCII replacement character 0x1a
 */
const uint8_t libuna_codepage_mac_icelandic_unicode_to_byte_stream_base_0x00a0[ 96 ] = {
	...
	0xdc, 0x84, 0xf1, 0xee, 0xef, 0xcd, 0x85, 0x1a,
...
const uint8_t libuna_codepage_mac_icelandic_unicode_to_byte_stream_base_0x2010[ 40 ] = {
...
/* Copies an Unicode character from a MacIcelandic encoded byte stream
 * Returns 1 if successful or -1 on error
 */
int libuna_codepage_mac_icelandic_copy_from_byte_stream(
...
{
	static char *function                             = "libuna_codepage_mac_icelandic_copy_from_byte_stream";
	...
	else
	{
		...
		safe_unicode_character = libuna_codepage_mac_icelandic_byte_stream_to_unicode_base_0x80[ byte_stream_character ];
	}
...
/* Copies an Unicode character to a MacIcelandic encoded byte stream
 * Returns 1 if successful or -1 on error
 */
int libuna_codepage_mac_icelandic_copy_to_byte_stream(
     libuna_unicode_character_t unicode_character,
     uint8_t *byte_stream,
     size_t byte_stream_size,
     size_t *byte_stream_index,
     libcerror_error_t **error )
{
	static char *function         = "libuna_codepage_mac_icelandic_copy_to_byte_stream";
	size_t safe_byte_stream_index = 0;
	      ...
	      && ( unicode_character < 0x0100 ) )
	{
		...
		byte_stream_value = libuna_codepage_mac_icelandic_unicode_to_byte_stream_base_0x00a0[ unicode_character ];
	}
	      ...
	      && ( unicode_character < 0x2038 ) )
	{
		...
		byte_stream_value = libuna_codepage_mac_icelandic_unicode_to_byte_stream_base_0x2010[ unicode_character ];
	}
