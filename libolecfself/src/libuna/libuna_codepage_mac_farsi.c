...
/* Extended ASCII to Unicode character lookup table for the MacFarsi codepage
 * Unknown are filled with the Unicode replacement character 0xfffd
 */
const uint16_t libuna_codepage_mac_farsi_byte_stream_to_unicode_base_0x80[ 128 ] = {
...
/* Unicode to ASCII character lookup tables for the MacFarsi codepage
 * Unknown are filled with the ASCII replacement character 0x1a
 */
const uint8_t libuna_codepage_mac_farsi_unicode_to_byte_stream_base_0x0020[ 32 ] = {
...
const uint8_t libuna_codepage_mac_farsi_unicode_to_byte_stream_base_0x00a0[ 96 ] = {
...
const uint8_t libuna_codepage_mac_farsi_unicode_to_byte_stream_base_0x0608[ 80 ] = {
...
const uint8_t libuna_codepage_mac_farsi_unicode_to_byte_stream_base_0x0668[ 88 ] = {
	0x1a, 0x1a, 0xa5, 0x1a, 0x1a, 0x1a, 0x1a, 0x1a,
	0x1a, 0x1a, 0x1a, 0x1a, 0x1a, 0x1a, 0x1a, 0x1a,
...
const uint8_t libuna_codepage_mac_farsi_unicode_to_byte_stream_base_0x06f0[ 16 ] = {
	0xb0, 0xb1, 0xb2, 0xb3, 0xb4, 0xb5, 0xb6, 0xb7,
	0xb8, 0xb9, 0x1a, 0x1a, 0x1a, 0x1a, 0x1a, 0x1a
};

/* Copies an Unicode character from a MacFarsi encoded byte stream
...
{
	static char *function                             = "libuna_codepage_mac_farsi_copy_from_byte_stream";
	...
	else
	{
		...
		safe_unicode_character = libuna_codepage_mac_farsi_byte_stream_to_unicode_base_0x80[ byte_stream_character ];
	}
...
/* Copies an Unicode character to a MacFarsi encoded byte stream
 * Returns 1 if successful or -1 on error
 */
int libuna_codepage_mac_farsi_copy_to_byte_stream(
     ...
     libcerror_error_t **error )
{
	static char *function         = "libuna_codepage_mac_farsi_copy_to_byte_stream";
	size_t safe_byte_stream_index = 0;
	      ...
	      && ( unicode_character < 0x0040 ) )
	{
		...
		byte_stream_value = libuna_codepage_mac_farsi_unicode_to_byte_stream_base_0x0020[ unicode_character ];
	}
	      ...
	      && ( unicode_character < 0x0100 ) )
	{
		...
		byte_stream_value = libuna_codepage_mac_farsi_unicode_to_byte_stream_base_0x00a0[ unicode_character ];
	}
	      ...
	      && ( unicode_character < 0x0658 ) )
	{
		...
		byte_stream_value = libuna_codepage_mac_farsi_unicode_to_byte_stream_base_0x0608[ unicode_character ];
	}
	else if( ( unicode_character >= 0x0668 )
	      && ( unicode_character < 0x06c0 ) )
	{
		unicode_character -= 0x0668;

		byte_stream_value = libuna_codepage_mac_farsi_unicode_to_byte_stream_base_0x0668[ unicode_character ];
	}
	else if( ( unicode_character >= 0x06f0 )
	      && ( unicode_character < 0x0700 ) )
	{
		unicode_character -= 0x06f0;

		byte_stream_value = libuna_codepage_mac_farsi_unicode_to_byte_stream_base_0x06f0[ unicode_character ];
	}
