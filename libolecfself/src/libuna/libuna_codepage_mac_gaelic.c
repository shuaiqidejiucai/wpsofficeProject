...
/* Extended ASCII to Unicode character lookup table for the MacGaelic codepage
 * Unknown are filled with the Unicode replacement character 0xfffd
 */
const uint16_t libuna_codepage_mac_gaelic_byte_stream_to_unicode_base_0x80[ 128 ] = {
...
/* Unicode to ASCII character lookup tables for the MacGaelic codepage
 * Unknown are filled with the ASCII replacement character 0x1a
 */
const uint8_t libuna_codepage_mac_gaelic_unicode_to_byte_stream_base_0x00a0[ 112 ] = {
	0xca, 0x1a, 0xa2, 0xa3, 0x1a, 0x1a, 0x1a, 0xa4,
	0xac, 0xa9, 0x1a, 0xc7, 0x1a, 0x1a, 0xa8, 0x1a,
	0xa1, 0xb1, 0x1a, 0x1a, 0xab, 0x1a, 0xa6, 0xe1,
	...
	0x1a, 0x96, 0x98, 0x97, 0x99, 0x9b, 0x9a, 0x1a,
	0xbf, 0x9d, 0x9c, 0x9e, 0x9f, 0xf7, 0x1a, 0xd8,
	0x1a, 0x1a, 0x1a, 0x1a, 0x1a, 0x1a, 0x1a, 0x1a,
	0x1a, 0x1a, 0xb5, 0xb6, 0x1a, 0x1a, 0x1a, 0x1a
};

const uint8_t libuna_codepage_mac_gaelic_unicode_to_byte_stream_base_0x2010[ 24 ] = {
	0x1a, 0x1a, 0x1a, 0xd0, 0xd1, 0x1a, 0x1a, 0x1a,
	0xd4, 0xd5, 0x1a, 0x1a, 0xd2, 0xd3, 0x1a, 0x1a,
	0xa0, 0x1a, 0xa5, 0x1a, 0x1a, 0x1a, 0xc9, 0x1a
};

/* Copies an Unicode character from a MacGaelic encoded byte stream
...
{
	static char *function                             = "libuna_codepage_mac_gaelic_copy_from_byte_stream";
	...
	else
	{
		...
		safe_unicode_character = libuna_codepage_mac_gaelic_byte_stream_to_unicode_base_0x80[ byte_stream_character ];
	}
...
/* Copies an Unicode character to a MacGaelic encoded byte stream
 * Returns 1 if successful or -1 on error
 */
int libuna_codepage_mac_gaelic_copy_to_byte_stream(
     ...
     libcerror_error_t **error )
{
	static char *function         = "libuna_codepage_mac_gaelic_copy_to_byte_stream";
	size_t safe_byte_stream_index = 0;
	      ...
	      && ( unicode_character < 0x0110 ) )
	{
		...
		byte_stream_value = libuna_codepage_mac_gaelic_unicode_to_byte_stream_base_0x00a0[ unicode_character ];
	}
	      ...
	      && ( unicode_character < 0x2028 ) )
	{
		...
		byte_stream_value = libuna_codepage_mac_gaelic_unicode_to_byte_stream_base_0x2010[ unicode_character ];
	}
	else switch( unicode_character )
	{
		case 0x0120:
			byte_stream_value = 0xbb;
			break;
